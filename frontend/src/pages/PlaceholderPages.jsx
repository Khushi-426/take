...
export const Signup = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      await axios.post("http://127.0.0.1:5001/api/auth/send-otp", {
  ...
  const handleVerifyAndSignup = async (otpValue = otp) => {
    ...
    try {
      const res = await axios.post(
        "http://127.0.0.1:5001/api/auth/signup-verify",
        {
          ...formData,
          otp: otpValue,
          role,
      ...
      <div className="auth-card">
        ...
        {message && (
          <div
            style={{
              color:
                otpSent && !message.includes("failed") ? "#2e7d32" : "#d32f2f",
              background:
                otpSent && !message.includes("failed") ? "#e8f5e9" : "#ffebee",
              padding: "10px",
              borderRadius: "8px",
              textAlign: "center",
              marginBottom: "15px",
...
export const Onboarding = () => (
  <div style={pageStyle}>
    ...
    <Link to="/profile/overview" className="auth-link">
...
export const CustomProgram = () => (
  <div style={pageStyle}>
    <h1>Custom Program</h1>
    <p>Coming Soon</p>
  </div>
);
export const AccuracyGraphs = () => (
  <div style={pageStyle}>
    <h1>Accuracy Analytics</h1>
    <p>Coming Soon</p>
  </div>
);
...
// REMOVED COMMUNITY PAGES (Achievements, Challenges, TherapistModule)
